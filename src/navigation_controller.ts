...
export class NavigationController {
  ...
  constructor(options: NavigationOptions) {
    ...
    this.workspaceMovement = new WorkspaceMovement(
      this.canCurrentlyEdit.bind(this),
    );
   ...
   * @param softWorkspaceFocus avoid workspace modifications.
   */
   ...
   * @param isFocused whether the environment has browser focus.
   * @param focusingWorkspaceForFlyoutKeyboardNavigation avoid workspace modifications.
   */
  updateWorkspaceFocus(
    workspace: WorkspaceSvg,
    isFocused: boolean,
    focusingWorkspaceForFlyoutKeyboardNavigation: boolean,
  ) {
    if (isFocused) {
      if (!focusingWorkspaceForFlyoutKeyboardNavigation) {
